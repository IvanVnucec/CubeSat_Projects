...
#define PSR_MAX_ARGUMENT_LENGTH (PSR_MAX_INPUT_STRING_LENGTH - PSR_MAX_INPUT_FUNCTION_NAME_LENGTH)
...
PSR_Status_t PSR_Compare_command(const PSR_Command_t *command, const char input_func_name[]);
